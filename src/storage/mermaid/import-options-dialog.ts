 ...
 * `knogra.mermaid.import` store (see `import-settings-store.ts`); the main dialog
...
import type { MermaidImportSelection } from './import-dialog';
import {
...
type LayoutChoice = MermaidImportSelection['layout'];
